...
export default function Projects(props) {
    ...
    const [filterValue, setFilterValue] = useState([{label: 'Featured', id: 'featured'}]);
    ...
    return (
        <React.Fragment>
            ...
            <div style={{zIndex: 100, width: '25%', paddingRight: '5vw', paddingBottom: '20px', colors: `${theme.colors.contentPrimary}`}}>
                ...
                value={filterValue}
                onChange={(params) => {setFilterValue(params.value); filterProjects(params.value[0].id, CARD_PROJECTS, cardProjects, setCardProjects); console.log(params.value)}}
            ...
            <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '50px'}}>
                ...
                onClick={() => {setFilterValue([{label: 'All', id: 'all'}]); filterProjects('all', CARD_PROJECTS, cardProjects, setCardProjects);}}>
                    Show All
                </Button>) : 
                (<Button kind={KIND.tertiary} shape={SHAPE.pill} 
                onClick={() => {setFilterValue([{label: 'Featured', id: 'featured'}]); filterProjects('featured', CARD_PROJECTS, cardProjects, setCardProjects);}}>
                    Hide
                </Button>)
                }
            </div>

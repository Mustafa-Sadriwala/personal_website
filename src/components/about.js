        ...
        <Grid gridGutters={[8, 16, 32]} align={ALIGNMENT.start}>
          <Cell span={[2, 2, 6]}>
            <Paragraph1>
              ...
              development, writing, and painting. For a brief explanation of
              recursion check out my personal website&nbsp;
              <StyledLink href="#">here!</StyledLink>
            </Paragraph1>
            <Paragraph1>
              Since being at UTD I've worked with an AI security start-up
              creating an Android application, interned at JP Morgan & Chase and
              Facebook, and helped to foster and grow the Computer Science
              community through the student chapter of the&nbsp;
              <StyledLink href="https://www.acmutd.co/" target="_blank">
                ACM at UTD.
              </StyledLink>
            </Paragraph1>
          </Cell>

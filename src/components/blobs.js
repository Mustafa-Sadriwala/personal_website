...
function createInitialBlobs(blobColors) {
  ...
  initialBlobsArr.push({
    color: blobColors[4],
    path:
      "M116.5,-85.1C149.7,-51.4,174.3,-3,153.7,14.2C133.2,31.5,67.5,17.5,13,54.3C-41.5,91,-84.8,178.4,-123.4,186.5C-162,194.7,-196.1,123.6,-187.8,68.9C-179.4,14.2,-128.8,-24.1,-90.5,-59C-52.1,-93.9,-26.1,-125.4,7.8,-131.7C41.7,-137.9,83.4,-118.8,116.5,-85.1Z",
...
function newBlobColors(blobs, blobColors) {
  if (blobs === undefined) return blobs;
  let newBlobs = blobs;
...
const Blobs = (props) => {
  ...
  useEffect(() => {
    ...
    if (!didMountRef.current) {
      ...
      shuffleArray(blobColors);
      setInitialBlobs(i => newBlobColors(i, blobColors));
      shuffleArray(blobColors);
      setRandomBlobs(r => newBlobColors(r, blobColors));
